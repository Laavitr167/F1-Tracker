...
const styles = StyleSheet.create({
  ...
  tabRow: { flexDirection: 'row', backgroundColor: '#1e1e1e', margin: 12, borderRadius: 12, overflow: 'hidden' },
  ...
  chartCard: { backgroundColor: '#1e1e1e', borderRadius: 12, padding: 16, marginBottom: 12 },
  ...
  statsCard: { backgroundColor: '#1e1e1e', borderRadius: 12, padding: 16, marginBottom: 24 },
